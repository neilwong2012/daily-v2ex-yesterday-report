...
test('report home keeps the page content-first', async () => {
  ...
  assert.match(layout, /\.topic-card > summary\s*\{[^}]*min-height: 62px[^}]*padding: 12px 16px/s);
  ...
  assert.match(layout, /\.topic-card > summary\s*\{[^}]*min-height: 58px[^}]*padding: 10px 12px/s);
