...
test('renders each analysis as safe Markdown with source and engagement stats at the bottom', () => {
  const item = {
    topic: {
      id: 123,
      title: '综合分析\n主题',
  ...
  assert.match(report, /<p class="topic-source"><span class="topic-source-link">原链接：<a href="https:\/\/www\.v2ex\.com\/t\/123" target="_blank" rel="noopener noreferrer">综合分析 主题<\/a><\/span><span class="topic-stats">回复 3 · 收藏 8<\/span><\/p>/);
  assert.ok(
    report.indexOf('<p class="topic-source">')
